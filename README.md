<a href="/img/openMINDS-publications_logo_light.png">
  <picture>
    <source media="(prefers-color-scheme: dark)" srcset="/img/openMINDS-publications_logo_dark.png">
    <source media="(prefers-color-scheme: light)" srcset="/img/openMINDS-publications_logo_light.png">
    <img alt="openMINDS publications metadata model" src="/img/openMINDS-publications_logo_light.png" title="Logo created by U. Schlegel, L. Zehl, C. Hagen Blixhavn" align="right" height="70">
  </picture>
</a>
...
There you can also explore directly the :arrow_right: [**openMINDS_publications schema specifications**][docu-publications-url].
...
Schema contributions to openMINDS_publications should be raised and discussed on the :arrow_right: [**issue tracker**][issuetracker-publications]  
...
[contributors-url]: https://github.com/openMetadataInitiative/openMINDS_publications/graphs/contributors
[contributors-shield]: https://img.shields.io/github/contributors/openMetadataInitiative/openMINDS_publications
[docu-url]: https://openminds-documentation.readthedocs.io
[docu-publications-url]: https://openminds-documentation.readthedocs.io/en/v3.0/schema_specifications/publications.html
...
[license-url]: https://raw.githubusercontent.com/openMetadataInitiative/openMINDS_publications/v1/LICENSE
[license-shield]: https://img.shields.io/github/license/openMetadataInitiative/openMINDS_publications
